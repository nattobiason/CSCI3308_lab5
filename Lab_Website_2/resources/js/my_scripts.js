...
function viewStudentStats(id, toggle){
	var vis = document.getElementById(id).style.visibility = "initial";
	var h = document.getElementById(id).style.height = "initial";
	if(toggle){
		vis = "visible";
		h = "auto";
	}
...
function switchPlayers(playNum){
	player = [{p_year: "year", p_major: "major", g_played: "# games", player_img: "img link",
			p_yards: "yards", r_yards: "yards", rec_yards: "yards"}];
	document.getElementById("p_year").innerHTML = player[playNum].p_year;
}
function loadPlayersPage(){
	var playNum = 0;
	var playerName = ("Player Name " + playNum);
	var anchor = document.createElement("A");
	anchor.href = "#";
	anchor.onclick = switchPlayers(playerNum);
	anchor.text = playerName;
